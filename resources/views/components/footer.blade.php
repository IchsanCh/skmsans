<footer class="bg-black text-white">
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <p class="text-gray-300 max-w-md">
                Kami percaya perubahan dimulai dari suara kecil. Isi surveynya di SurveyLo dan bantu wujudkan pelayanan
                yang kamu harapkan.
            </p>
            <!-- Social media icons -->
            <div class="flex space-x-4 pt-2 items-center">
                ...
                <a href="https://www.tiktok.com/@lotusaja.com" target="_blank"
    ...
    <div class="bg-black border-t border-gray-500">
        <div class="container mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center">
            ...
            <p class="text-gray-400 text-sm">© 2025 SurveyLo. All rights reserved.</p>
        </div>
    </div>
    <script>
